...
if st.session_state.aktif_sayfa == "Ana Sayfa":
    ...
    # 1. Sınıfın değerini toplu uygulama için en üstte yakalayabilmek adına session_state veya özel state yönetimi:
    ...
    def fiyatlandirma_formu():
        ...
        # 1. Sınıf özel alanı ve toplu uygulama mekanizması
        ...
        for i in range(2, 46):
            ...
            # 1. sınıfa girilen avukat ücreti diğer tüm sınıflara doğrudan yansıtılır
